...
description: "Project knowledge accumulation system. This skill should be used when the user asks to 'learn from mistakes', 'record experience', 'save learnings', 'accumulate knowledge', '记录经验', '学习总结', '经验积累', '避免重复错误', '保存学习成果', '知识沉淀', or needs to capture reusable patterns from debugging sessions."
metadata:
  version: "1.0.0"
  mode: observe-only
---
