---
name: session-end
description: Session wrap-up - update handoff, commit changes, auto-record experience. This skill should be used when the user says 'session end', '结束', '收工', '今天到这', '先这样', 'that is all', 'heading out', '下班了', '退出', or any exit signal indicating end of work session.
allowed-tools:
  - Read
  - Write
  - Edit
