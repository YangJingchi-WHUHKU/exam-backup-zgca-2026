...
description: Systematic debugging - four-phase process, find root cause before fixing. This skill should be used when the user encounters errors, bugs, test failures, build failures, lint errors, or says 'debug', '调试', '报错了', '出bug了', '测试失败', '构建失败', 'fix this error', '怎么修'. Always use this skill before attempting blind fixes.
---
